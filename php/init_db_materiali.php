...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS giacenze_materiali (
        ...
        quantita_attuale DECIMAL(10,3) DEFAULT 0 COMMENT 'Quantità attualmente presente',
        quantita_riservata DECIMAL(10,3) DEFAULT 0 COMMENT 'Quantità riservata/prenotata',
        quantita_disponibile DECIMAL(10,3) GENERATED ALWAYS AS (quantita_attuale - quantita_riservata) STORED COMMENT 'Quantità effettivamente disponibile',
    ...
    $sql = "CREATE TABLE IF NOT EXISTS LogVariazioniMateriali (
        ...
        quantita_precedente DECIMAL(10,3) COMMENT 'Quantità prima della variazione',
        quantita_variazione DECIMAL(10,3) COMMENT 'Quantità della variazione (+/-)',
        quantita_attuale DECIMAL(10,3) COMMENT 'Quantità dopo la variazione',
    ...
    $sql = "CREATE TABLE IF NOT EXISTS MovimentiMateriali (
        ...
        prezzo_unitario DECIMAL(10,4) COMMENT 'Prezzo unitario (per valorizzazione)',
    ...
    $sql = "CREATE TABLE IF NOT EXISTS AlertMateriali (
        ...
        soglia_riferimento DECIMAL(10,3),
